...
export default function SignInPage() {
  ...
  const handleSocialAuth = async (provider: string) => {
    ...
    try {
      // Use the new Web3Auth social login method
  ...
  //   try {
  //     // Use the new Web3Auth modal login
  //     await loginWithWeb3Auth();
  //     toast.success('Web3 authentication successful!', {
  //       message: 'Welcome back to Partisipro',
  //       duration: 3000,
  //     });
  //     // Navigation will be handled by the useEffect above
  //   } catch (err) {
  //     // Web3Auth error is handled by useAuth hook
  //   } finally {
  //     setIsLoading(false);
  //   }
  // };
