...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setTimeout(() => {
        toast.success(t('auth.signUp.messages.success'), {
          message: t('auth.signUp.messages.welcome'),
          duration: 3000,
        });
      }, 300);
  ...
  const handleSocialAuth = async (provider: string) => {
    ...
    try {
      ...
      setTimeout(() => {
        toast.success(t('auth.signUp.messages.socialSuccess', { provider }), {
          message: t('auth.signUp.messages.welcome'),
          duration: 3000,
        });
      }, 300);
        ...
        <div className="w-full flex flex-col justify-center items-center text-center text-white p-12 relative z-10">
          <div className="max-w-md animate-fade-in-up animate-delay-300">
            <h2 className="text-3xl font-bold mb-4">
              {t('auth.signUp.joinFuture')}
            </h2>
            <p className="text-lg text-white/90 mb-6">
              {t('auth.signUp.startJourney')}
            </p>
            <div className="glass-hero p-6 rounded-2xl">
              <p className="text-sm text-white/95">
                &ldquo;{t('auth.signUp.inspirationQuote')}&rdquo;
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              >
                ...
                <span className="ml-2 text-sm font-medium">
                  {t('auth.signUp.socialButtons.google')}
                </span>
              </button>
              ...
              >
                ...
                <span className="ml-2 text-sm font-medium">
                  {t('auth.signUp.socialButtons.apple')}
                </span>
              </button>
              ...
              >
                ...
                <span className="ml-2 text-sm font-medium">
                  {t('auth.signUp.socialButtons.facebook')}
                </span>
              </button>
            </div>
          </form>
