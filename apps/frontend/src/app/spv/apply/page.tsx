      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="md:col-span-2">
          ...
          <textarea
            ...
            placeholder="Describe your company's main business activities, expertise, and focus areas..."
            rows={4}
            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500"
          />
  ...
  const renderStep2 = () => (
    <div className="space-y-6">
      <div className="text-center mb-6">
        ...
        <p className="text-gray-600">Contact details and company address</p>
      </div>
  ...
  const renderStep4 = () => (
    <div className="space-y-6">
      <div className="text-center mb-6">
        ...
        <p className="text-gray-600">
          Secure wallet configuration for project management
        </p>
      </div>
            ...
            <ScrollReveal animation="slide-up" delay={0}>
              <div className="text-center mb-8">
                ...
                <p className="text-xl text-muted-foreground">
                  Apply to become a Special Purpose Vehicle (SPV) on the
                  Partisipro platform
                </p>
              </div>
            </ScrollReveal>
