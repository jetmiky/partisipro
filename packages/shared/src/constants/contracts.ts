...
export const CONTRACT_ADDRESSES = {
  ...
  // Chainlink Contracts
  CHAINLINK_PRICE_FEED_IDR_USD: process.env
    .CHAINLINK_PRICE_FEED_IDR_USD as Address,
  CHAINLINK_AUTOMATION_REGISTRY: process.env
    .CHAINLINK_AUTOMATION_REGISTRY as Address,
